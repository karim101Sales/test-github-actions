...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Quarto 1.3 Feature}, coltitle=black, colback=white, opacitybacktitle=0.6, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, arc=.35mm, opacityback=0, rightrule=.15mm, left=2mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white]
...
Knuth, Donald E. 1986. \emph{The {TeX} Book}. Addison-Wesley
Professional.
